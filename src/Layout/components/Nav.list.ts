...
export const NavList: INav[] = [
  ...
  },
  {
    ...
    title: "Forms",
    nav: [
      { id: 0, external: false, description: "Overview", link: "/form" },
  ...
  },
  {
    ...
    title: "Components",
    nav: [
      { id: 0, external: false, description: "Overview", link: "/components/" },
      { id: 1, external: false, description: "Buttons", link: "/components/button" },
      { id: 2, external: false, description: "Icons", link: "/components/icons" },
      { id: 3, external: false, description: "Icon List", link: "/components/iconlist" },
      { id: 4, external: false, description: "Dropdown", link: "/components/dropdown" },
      { id: 5, external: false, description: "Card", link: "/components/card" },
      { id: 6, external: false, description: "Header", link: "/components/header" },
      { id: 7, external: false, description: "Carousel", link: "/components/carousel" },
      { id: 8, external: false, description: "Footer", link: "/components/footer" },
  ...
  },
  {
    ...
    title: "Utilities",
    nav: [
      { id: 0, external: false, description: "Overview", link: "/utilities" },
      { id: 0, external: false, description: "Colors", link: "/utilities/colors" },
      { id: 1, external: false, description: "Borders", link: "/utilities" },
